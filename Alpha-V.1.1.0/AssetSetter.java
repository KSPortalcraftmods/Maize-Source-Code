...
public class AssetSetter {
	...
	public void setObject() {
		...
		gp.obj[2].worldY =  7 * gp.tileSize; //This is for the first world map do change for when the map gets redisgned!!!
		
		gp.obj[3] = new OBJ_Door();
		gp.obj[3].worldX =  10 * gp.tileSize; //This is for the first world map do change for when the map gets redisgned!!!
		gp.obj[3].worldY =  9 * gp.tileSize; //This is for the first world map do change for when the map gets redisgned!!!
		
		gp.obj[4] = new OBJ_Door();
		gp.obj[4].worldX =  8 * gp.tileSize; //This is for the first world map do change for when the map gets redisgned!!!
		gp.obj[4].worldY =  28 * gp.tileSize; //This is for the first world map do change for when the map gets redisgned!!!
		...
		gp.obj[7].worldX =  10 * gp.tileSize; //This is for the first world map do change for when the map gets redisgned!!!
		gp.obj[7].worldY =  5 * gp.tileSize; //This is for the first world map do change for when the map gets redisgned!!!
