	...
	public void pickUpObject(int i) {
		...
		if(i != 999) {
   	  ...
   	  case "Veggie":
  		  ...
  		  speed += 1/2; 
   		 gp.obj[i] = null;
   		 System.out.println("You Found The Hidden Aspauagus: Great Job! Plus you feel more engry rushing through your body.");
  		 break;
   	  case "Boots":
   		 gp.playSE(2);
   		  speed += 1;
   		  gp.obj[i] = null;
   		 System.out.println("You suddenly feel faster.");
   		  break;
   	  case "Slow_Boots":
   		 gp.playSE(5);
   		  speed -= 1;
   		  gp.obj[i] = null;
   		  System.out.println("You suddenly feel a heafty burden on your feet but you cannot seem to get it off.");
   		  break;
	  }
